...
[task_local]
#京喜财富岛
15 3-5/1 * * * jd_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "15 3-5/1 * * *" script-path=jd_cfd.js,tag=京喜财富岛

===============Surge=================
京喜财富岛 = type=cron,cronexp="15 3-5/1 * * *",wake-system=1,timeout=3600,script-path=jd_cfd.js

============小火箭=========
京喜财富岛 = type=cron,script-path=jd_cfd.js, cronexpr="15 3-5/1 * * *", timeout=3600, enable=true
 */
