...
[task_local]
#闪购盲盒
20 7 * * * jd_sgmh.js, tag=闪购盲盒, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "20 7 * * *" script-path=jd_sgmh.js, tag=闪购盲盒

===============Surge=================
闪购盲盒 = type=cron,cronexp="20 7 * * *",wake-system=1,timeout=3600,script-path=jd_sgmh.js

============小火箭=========
闪购盲盒 = type=cron,script-path=jd_sgmh.js, cronexpr="20 7 * * *", timeout=3600, enable=true
