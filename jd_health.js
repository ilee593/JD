...
[task_local]
#东东健康社区
3,31,40 0 * * * jd_health.js, tag=东东健康社区, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "3,31,40 0 * * *" script-path=jd_health.js, tag=东东健康社区

====================Surge================
东东健康社区 = type=cron,cronexp="3,31,40 0 * * *",wake-system=1,timeout=3600,script-path=jd_health.js

============小火箭=========
东东健康社区 = type=cron,script-path=jd_health.js, cronexpr="3,31,40 0 * * *", timeout=3600, enable=true
 */
